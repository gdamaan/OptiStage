...
public interface IAdministratorService {
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.IAdministratorService#login(String, String)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.IAdministratorService#getAdminById(Long)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.IAdministratorService#updateAdmin(Administrator)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.IAdministratorService#deleteAdmin(Long)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.IAdministratorService#createAdmin(Administrator)
     */
