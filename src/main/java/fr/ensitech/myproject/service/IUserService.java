...
public interface IUserService {
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.UserService#unsubscribe(String email)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.UserService#updateProfile(User)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.UserService#subscribe(User)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.UserService#getUserById(Long id)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.UserService#getUserByEmail(String email)
     */
     ...
     * @author Amaan GD
     * @since 2026-05-20
     * @see fr.ensitech.myproject.service.UserService#updatePassword(Long, String)
     */
