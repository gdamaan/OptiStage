package fr.ensitech.optistage.main;

import fr.ensitech.optistage.repository.HibernateConnector;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages(
                    "fr.ensitech.optistage.controller.rest",
                    "fr.ensitech.optistage.filter"
            );
